...
For example git clone https://github.com/ayeshatahirme/flutter-drawer-app.git
```
#### •	Option 2
...
To run the project, you need to open it in Visual Studio Code. Open the project folder, there will be another folder named **“flutter-drawer-app”**. This folder contains the files that you will need to set up the project.
...
Now you are all set to run the project. To run the Visual Studio Code run **flutter run** command or use **flutter run -d chrome** to run application on chrome.

### Screenshots of app
![flutter_drawer_app_2018-CS-22](https://user-images.githubusercontent.com/48019432/115154892-a2b15000-a096-11eb-973d-a5de98d42d59.JPG)
